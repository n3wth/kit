...
**Architecture:** Next.js marketing site + shadcn registry hosted at kit.n3wth.com. The registry serves component JSON via the shadcn protocol. AI context packs (.cursorrules, CLAUDE.md, MCP config) ship alongside. CLI scaffolds new projects with the full design system pre-loaded.
...
| E4 | Marketing site (kit.n3wth.com) | site | E1 |
